        ...
        <div className="bg-gray-50 flex items-center justify-center p-8 lg:p-16 -mb-12 mt-12">
          <div className="max-w-md space-y-8">
            <div className="text-left">
              <h2 className="text-3xl lg:text-4xl font-light tracking-[0.1em] text-gray-900 mb-8">Overview of Agriculture in Ghana</h2>
            </div>
            ...
            <ul className='text-left'>•	GDP Contribution: In 2016, agriculture contributed 19.5% to Ghana’s GDP (ISSER, 2016).</ul>
            <ul className='text-left'>•	Land Use: 56% of Ghana’s land area is used for cultivation.</ul>  
    ...
    <div className='container mx-auto px-4 lg:px-8 text-center'>
      ...
      <div className="grid lg:grid-cols-2 min-h-[80vh] -mt-12 "> {/* Added gap */}
        ...
        <div className="bg-gray-50 flex items-center justify-center p-8 lg:p-16 order-2 lg:order-1 ">
          <div className="max-w-md space-y-8">
            <div className="text-left">
              <h2 className="text-3xl lg:text-4xl font-light tracking-[0.1em] text-gray-900 mb-8">Key Challenges in the Agricultural Sector</h2>
            </div>
            <p className='text-left'>Despite its growing global demand, Ghana’s shea butter sector faces several structural and operational 
